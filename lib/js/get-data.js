...
FHIR.oauth2.ready().then(function(client) {
  ...
  var run = function(sodium, BP) {
    ...
    riskDiagnosis = nodes.determineUnknown();
    nodes.draw("canvas");
  };
  run(140,200)
  ...
  function displayHeartRiskDiagnosis(){
    if(sodiumLevel != undefined && bloodPressureLevel != undefined ){
      risk.innerHTML = riskDiagnosis;

    }else{
      risk.innerHTML = 'Not enough data on the patient file. Heart risk diagnosis cannot be made.'
    }
  }
